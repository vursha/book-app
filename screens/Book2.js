...
const Book2 = () => {
  ...
  return (
    ...
    <View style={{marginBottom:20,flexDirection:"row"}} key={index}>
      ...
      {/* <Button style={{fontSize: 20, color: 'green'}}  title="Press Me">Press Me</Button> */}
      <View style={{flexDirection:"row",justifyContent:"flex-start"}}>
        <Text style={{color:"white",marginRight:25}}>{item.pages[0]}</Text>
        <Text style={{color:"white",marginRight:25}}>{item.pages[1]}</Text>
      </View>
